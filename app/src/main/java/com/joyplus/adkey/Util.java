...
public class Util {
	...
	public static String getLocalIpAddress() {
		if(AdkeyData.isDeBug()){
			com.joyplus.adkey.widget.Log.i("ClientINFO",IPAdress);
		}
				...
				for (Enumeration<NetworkInterface> en = NetworkInterface
					...
					for (Enumeration<InetAddress> enumIpAddr = intf
						...
						if (!inetAddress.isLoopbackAddress()) {
							if(AdkeyData.isDeBug()){
								com.joyplus.adkey.widget.Log.i("ClientINFO",inetAddress.getHostAddress().toString());
							}
							return IPAdress = inetAddress.getHostAddress().toString();
						}
					}
				}
