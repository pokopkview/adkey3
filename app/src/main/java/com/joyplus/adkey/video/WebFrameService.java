...
public class WebFrameService extends FrameLayout implements BrowserControl {
...
//			mWebView_LAYER_TYPE_SOFTWARE = WebView.class.getField("LAYER_TYPE_SOFTWARE");
	...
	public WebFrameService(Context context, boolean allowNavigation,
		 ...
		 * @author yyc
		 */
//		mWebChromeClient = new WebChromeClient(mService);
		mWebView.setWebChromeClient(mWebChromeClient);
		
//		mWebViewClient = new WebViewClient(mService, allowNavigation);
		mWebView.setWebViewClient(mWebViewClient);
		final Service localContext = (Service)context;
		if(showExit){
